...
const reporting_update_1 = require("./reporting.update");
...
exports.ReportingModule = ReportingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [reporting_service_1.ReportingService, reporting_update_1.ReportingUpdate, prisma_service_1.PrismaService],
    })
], ReportingModule);
